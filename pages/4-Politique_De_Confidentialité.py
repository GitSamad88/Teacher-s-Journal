...
privacy_policy_html="""<h1>Politique de confidentialité</h1>
<p>Dernière mise à jour : 10 décembre 2023</p>
...
<ul>
<li>
<p><strong>Compte</strong> signifie un compte unique créé pour vous permettre d'accéder à notre service ou à des parties de notre service.</p>
</li>
<li>
<p><strong>Affilié</strong> signifie une entité qui contrôle, est contrôlée par, ou est sous le contrôle commun d'une partie, où "contrôle" signifie la propriété de 50 % ou plus des actions, de l'intérêt patrimonial, ou d'autres titres ayant droit de vote pour l'élection des directeurs ou d'autres autorités de gestion.</p>
</li>
<li>
<p><strong>Société</strong> (désignée comme "la Société", "Nous", "Nous" ou "Notre" dans cet Accord) fait référence à Multipage App.</p>
</li>
<li>
<p><strong>Cookies</strong> sont de petits fichiers placés sur votre ordinateur, appareil mobile ou tout autre appareil par un site web, contenant les détails de votre historique de navigation sur ce site parmi ses nombreuses utilisations.</p>
</li>
<li>
<p><strong>Pays</strong> se réfère à : Maroc</p>
</li>
<li>
...
<li>
<p><strong>Prestataire de services</strong> désigne toute personne physique ou morale qui traite les données au nom de la Société. Il s'agit de sociétés ou d'individus tiers employés par la Société pour faciliter le service, fournir le service au nom de la Société, effectuer des services liés au service ou aider la Société à analyser la manière dont le service est utilisé.</p>
</li>
<li>
<p><strong>Service de médias sociaux tiers</strong> fait référence à tout site web ou tout site web de réseau social via lequel un utilisateur peut se connecter ou créer un compte pour utiliser le service.</p>
</li>
<li>
...
<li>
<p><strong>Site web</strong> fait référence à Multipage App, accessible depuis <a href="https://moudakira.onrender.com/" rel="external nofollow noopener" target="_blank">https://moudakira.onrender.com/</a></p>
</li>
<li>
...
<h4>Informations provenant de services de médias sociaux tiers</h4>
...
<ul>
<li><strong>Cookies ou cookies de navigateur.</strong> Un cookie est un petit fichier placé sur votre appareil. Vous pouvez demander à votre navigateur de refuser tous les cookies ou de vous avertir lorsqu'un cookie est envoyé. Cependant, si vous n'acceptez pas les cookies, vous ne pourrez peut-être pas utiliser certaines parties de notre service. Sauf si vous avez modifié les paramètres de votre navigateur pour qu'il refuse les cookies, notre service peut utiliser des cookies.</li>
<li><strong>Balises web.</strong> Certaines sections de notre service et de nos e-mails peuvent contenir de petits fichiers électroniques appelés balises web (également appelées gifs transparents, balises pixel et gifs à pixel unique) qui permettent à la Société, par exemple, de compter les utilisateurs qui ont visité ces pages ou ouvert un e-mail et pour d'autres statistiques de site web connexes (par exemple, enregistrement de la popularité d'une certaine section et vérification de l'intégrité du système et du serveur).</li>
</ul>
<p>Les cookies peuvent être des cookies "persistants" ou des cookies "de session". Les cookies persistants restent sur votre ordinateur personnel ou votre appareil mobile lorsque vous êtes hors ligne, tandis que les cookies de session sont supprimés dès que vous fermez votre navigateur web. Vous pouvez en apprendre davantage sur les cookies sur l'article du site web <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank">TermsFeed</a>.</p>
...
<li>
<p><strong>Cookies de politique / acceptation de l'avis sur les cookies</strong></p>
...
<p>Type : Cookies persistants</p>
<p>Administrés par : Nous</p>
<p>Objectif : Ces cookies nous permettent de mémoriser les choix que vous faites lorsque vous utilisez le site web, tels que mémoriser vos détails de connexion ou vos préférences linguistiques. Ces cookies ont pour but de vous offrir une expérience plus personnelle et d'éviter que vous ayez à saisir à nouveau vos préférences à chaque utilisation du site web.</p>
</li>
</ul>
<p>Pour plus d'informations sur les cookies que nous utilisons et vos choix concernant les cookies, veuillez consulter notre politique de cookies ou la section des cookies de notre politique de confidentialité.</p>
<h3>Utilisation de vos données personnelles</h3>
<p>La Société peut utiliser les données personnelles à des fins suivantes :</p>
<ul>
<li>
<p><strong>Fournir et maintenir notre service</strong>, y compris surveiller l'utilisation de notre service.</p>
</li>
<li>
<p><strong>Gérer votre compte :</strong> gérer votre inscription en tant qu'utilisateur du service. Les données personnelles que vous fournissez peuvent vous donner accès à différentes fonctionnalités du service disponibles pour vous en tant qu'utilisateur enregistré.</p>
</li>
<li>
...
<li>
<p><strong>Vous fournir</strong> des nouvelles, des offres spéciales et des informations générales sur d'autres biens, services et événements que nous offrons et qui sont similaires à ceux que vous avez déjà achetés ou demandés, sauf si vous avez choisi de ne pas recevoir de telles informations.</p>
</li>
<li>
<p><strong>Gérer vos demandes :</strong> répondre et gérer vos demandes à notre égard.</p>
</li>
<li>
<p><strong>Pour les transferts d'entreprise :</strong> Nous pouvons utiliser vos informations pour évaluer ou effectuer une fusion, une cession, une restructuration, une réorganisation, une dissolution ou toute autre vente ou transfert de tout ou partie de nos actifs, que ce soit en tant qu'entreprise en activité ou dans le cadre d'une procédure de faillite, de liquidation ou de procédure similaire, dans laquelle les données personnelles détenues par nous concernant nos utilisateurs de service font partie des actifs transférés.</p>
</li>
<li>
...
<ul>
<li><strong>Avec des prestataires de services :</strong> Nous pouvons partager vos informations personnelles avec des prestataires de services pour surveiller et analyser l'utilisation de notre service, et pour vous contacter.</li>
<li><strong>Pour les transferts d'entreprise :</strong> Nous pouvons partager ou transférer vos informations personnelles dans le cadre de, ou pendant les négociations d'une fusion, d'une vente d'actifs de l'entreprise, d'un financement ou d'une acquisition de tout ou partie de notre entreprise à une autre société.</li>
<li><strong>Avec des affiliés :</strong> Nous pouvons partager vos informations avec nos affiliés, auquel cas nous demanderons à ces affiliés de respecter cette politique de confidentialité. Les affiliés comprennent notre société mère et toutes les filiales, partenaires de coentreprise ou autres sociétés que nous contrôlons ou qui sont sous notre contrôle commun.</li>
<li><strong>Avec des partenaires commerciaux :</strong> Nous pouvons partager vos informations avec nos partenaires commerciaux pour vous offrir certains produits, services ou promotions.</li>
<li><strong>Avec d'autres utilisateurs :</strong> Lorsque vous partagez des informations personnelles ou interagissez dans des espaces publics avec d'autres utilisateurs, ces informations peuvent être consultées par tous les utilisateurs et peuvent être distribuées publiquement. Si vous interagissez avec d'autres utilisateurs ou vous inscrivez via un service de médias sociaux tiers, les contacts de votre compte sur le service de médias sociaux tiers peuvent voir votre nom, votre profil, vos photos et la description de votre activité. De même, d'autres utilisateurs pourront voir les descriptions de votre activité, communiquer avec vous et consulter votre profil.</li>
...
<p>Vos informations, y compris les données personnelles, sont traitées dans les bureaux opérationnels de la Société et dans tout autre lieu où les parties impliquées dans le traitement sont situées. Cela signifie que ces informations peuvent être transférées vers des ordinateurs situés en dehors de votre État, province, pays ou autre juridiction gouvernementale où les lois sur la protection des données peuvent différer de celles de votre juridiction.</p>
...
<p>La Société prendra toutes les mesures raisonnablement nécessaires pour garantir que vos données sont traitées de manière sécurisée et conformément à cette Politique de confidentialité, et aucun transfert de vos données personnelles ne sera effectué vers une organisation ou un pays à moins qu'il n'y ait des contrôles adéquats en place, y compris la sécurité de vos données et autres informations personnelles.</p>
...
<p>Vous pouvez mettre à jour, modifier ou supprimer vos informations à tout moment en vous connectant à votre compte, le cas échéant, et en visitant la section des paramètres du compte qui vous permet de gérer vos informations personnelles. Vous pouvez également nous contacter pour demander l'accès, la correction ou la suppression de toutes les informations personnelles que vous nous avez fournies.</p>
...
<p>La sécurité de vos données personnelles est importante pour nous, mais rappelez-vous qu'aucune méthode de transmission sur Internet, ni méthode de stockage électronique, n'est totalement sécurisée. Bien que nous nous efforcions d'utiliser des moyens commercialement acceptables pour protéger vos données personnelles, nous ne pouvons garantir une sécurité absolue.</p>
<h2>Confidentialité des enfants</h2>
<p>Notre service ne s'adresse à personne de moins de 13 ans. Nous ne collectons sciemment aucune information d'identification personnelle auprès de personnes de moins de 13 ans. Si vous êtes un parent ou un tuteur et que vous savez que votre enfant nous a fourni des données personnelles, veuillez nous contacter. Si nous découvrons que nous avons collecté des données personnelles auprès de personnes de moins de 13 ans sans vérification du consentement parental, nous prendrons des mesures pour supprimer ces informations de nos serveurs.</p>
<p>Si nous devons nous baser sur le consentement comme base légale pour traiter vos informations et que votre pays exige le consentement d'un parent, nous pouvons exiger le consentement de vos parents avant de collecter et d'utiliser ces informations.</p>
...
<p>Nous n'avons aucun contrôle sur le contenu, les politiques de confidentialité ou les pratiques de tout site tiers ou service, et nous n'assumons aucune responsabilité quant au contenu, aux politiques de confidentialité ou aux pratiques de ces sites ou services tiers.</p>
...
<p>Nous vous informerons également par e-mail et/ou par un avis bien visible sur notre service, avant que le changement ne devienne effectif, et nous mettrons à jour la date de "Dernière mise à jour" en haut de cette politique de confidentialité.</p>
<p>Il est conseillé de consulter périodiquement cette politique de confidentialité pour prendre connaissance des éventuels changements. Les changements apportés à cette politique de confidentialité sont effectifs lorsqu'ils sont publiés sur cette page.</p>
<h2>Nous contacter</h2>
<p>Si vous avez des questions concernant cette politique de confidentialité, vous pouvez nous contacter :</p>
<ul>
<li>Par e-mail : samadtaoufik@gmail.com</li>
</ul>
"""
